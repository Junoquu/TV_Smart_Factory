...
def blue_back_panel():
    ...
    # Blue Back Panel UP
    action_client.send_goal(target = [51.1, 138.7, 69.0, 75.0], mode = 1)
    time.sleep(2)
    ...
    # Blue Back Panel
    action_client.send_goal(target = [51.1, 138.7, -40.0, 75.0], mode = 1)
    time.sleep(2)
    ...
    # Home Down
    action_client.send_goal(target = [126.2, 0.0, 0.0, 70.0], mode = 1)
    time.sleep(2)
...
def white_back_panel():
    ...
    # White Back Panel
    action_client.send_goal(target = [91.0, 144.6, -40.0, 57.8], mode = 1)
    time.sleep(2)
...
def red_back_panel():
    ...
    # Red Back Panel
    action_client.send_goal(target = [130.5, 153.2, -40.0, 49.6], mode = 1)
    time.sleep(2)
